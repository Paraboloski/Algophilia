...
if TYPE_CHECKING:
    ...
    from Backend.api.models.core.souls import Soul
...
class Character(Base):
    ...
    soul_id: Mapped[int | None] = mapped_column(ForeignKey("soul.id", ondelete="SET NULL"))
    ...
    inventory: Mapped["Inventory"] = relationship(back_populates="character", uselist=False, cascade="all, delete-orphan")

    stats: Mapped[list["CharacterStat"]] = relationship(back_populates="character", cascade="all, delete-orphan")
    
    skills: Mapped[list["CharacterSkill"]] = relationship(back_populates="character", cascade="all, delete-orphan")
    
    conditions: Mapped[list["CharacterCondition"]] = relationship(back_populates="character", cascade="all, delete-orphan")
    
    knowledges: Mapped[list["CharacterKnowledge"]] = relationship(back_populates="character", cascade="all, delete-orphan")
...
class CharacterKnowledge(Base):
    ...
    is_proficient: Mapped[bool] = mapped_column(default=False)
