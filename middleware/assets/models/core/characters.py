...
class Character(SQLModel, table=True):
    ...
    soul_id: int | None = Field(default=None, foreign_key="soul.id", ondelete="SET NULL")
    origin_id: int | None = Field(default=None, foreign_key="origin.id", ondelete="SET NULL")
...
class CharacterStat(SQLModel, table=True):
    ...
    character_id: int = Field(foreign_key="character.id", ondelete="CASCADE", primary_key=True)
    stat_id: int = Field(foreign_key="stat.id", ondelete="CASCADE", primary_key=True)
...
class CharacterCondition(SQLModel, table=True):
    ...
    character_id: int = Field(foreign_key="character.id", ondelete="CASCADE", primary_key=True)
    condition_id: int = Field(foreign_key="condition.id", ondelete="CASCADE", primary_key=True)
